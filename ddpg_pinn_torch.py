...
def f(s,a, net):
    ...
    #pde = u_s - u*u_a - (0.01/pi)*u_aa   #burger equation 1005 run
    
    pde = u_s + u*u_a - (0.01/pi)*u_aa   #burger equation  previous run
    
    #pde = u_s + u_a 
    
    #pde = u_s + u*u_a + u_aa + u_aaaa    #Kuramoto-Sivashinsky equation  
    
    #pde = u_s + 6*u*u_a + u_aaa  # Korteweg-de Vries (KdV) equation 
