...
class Env():
    ...
    def setReward(self, state, done):
    	...
    	#height_reward,acc_reward, and orient_reward could be neglected while directional module(action-space) were introduce
    	
    	reward = 0.1*joint_reward + 0.50*dis_reward + 0.5*dir_reward 
