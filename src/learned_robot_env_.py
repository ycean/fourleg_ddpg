...
class Env():
    ...
    def setReward(self, state, done):
    	...
    	if done:
    		...
    		if self.dir_error:
    			...
    			file_name1 = 'ddpg_pinn_b_goal_reward_'+ str(self.index) +'.csv'
    			np.savetxt(file_name1, self.score, delimiter=",") # Rewards
    			file_name2 = 'ddpg_pinn_b_pose_'+ str(self.index) +'.csv'
    			np.savetxt(file_name2, pose_, delimiter=",") # Rewasrdss
    			file_name3 = 'ddpg_pinn_b_action_'+ str(self.index) +'.csv'
    			np.savetxt(file_name3, joint_, delimiter=",") # Rewards
    			file_name4 = 'ddpg_pinn_b_goal_pose_'+ str(self.index) +'.csv'
    ...
    def step(self, action, past_action):
    	...
    	for t in range(w_t):
    		...
    		if dir_mode == 8: #front
    			if t <= 5: #60:
    				Q11 = L11*0.5*(1-cos(12*pi*(t/30))) #add'*12'
    				Q12 = L12*sin(12*pi*(t/30))
    				Q13 = L13*sin(12*pi*(t/30))
    			...
    			elif 5< t <=10: #60< t <=120:
    				Q31 = L31*0.5*(1-cos(12*pi*((t-5)/30))) #pi*((t-60)/30)))
    				Q32 = L32*sin(12*pi*((t-5)/30)) #pi*((t-60)/30))
    				Q33 = L33*sin(12*pi*((t-5)/30)) #pi*((t-60)/30))
    				...
    				self.save_pose_record([self.pose.x,self.pose.y,self.pose.z])
    				self.save_goal_record([self.goal_x,self.goal_y])
    			elif 10< t <=15: #120< t <=180:
    				Q21 = L21*0.5*(1-cos(12*pi*((t-10)/30))) #pi*((t-120)/30)))
    				Q22 = L22*sin(12*pi*((t-10)/30)) #pi*((t-120)/30))
    				Q23 = L23*sin(12*pi*((t-10)/30)) #pi*((t-120)/30))
    				...
    				Q41 = L41*0.5*(1-cos(12*pi*((t-15)/30))) #pi*((t-180)/30)))
    				Q42 = L42*sin(12*pi*((t-15)/30)) #pi*((t-180)/30))
    				Q43 = L43*sin(12*pi*((t-15)/30)) #pi*((t-180)/30))
    			...
    			if t <= 5:
    				Q21 = L21*0.5*(1-cos(12*pi*(t/30))) #add'*12'
    				Q22 = L22*sin(12*pi*((t)/30))
    				Q23 = L23*sin(12*pi*((t)/30))
    				...
    				Q41 = L41*0.5*(1-cos(12*pi*((t-5)/30))) #pi*((t-60)/30)))
    				Q42 = L42*sin(12*pi*((t-5)/30)) #pi*((t-60)/30))
    				Q43 = L43*sin(12*pi*((t-5)/30)) #pi*((t-60)/30))
    				Q21,Q22,Q23,Q11,Q12,Q13,Q31,Q32,Q33 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    				...
    				Q31 = L31*0.5*(1-cos(12*pi*((t-10)/30))) #pi*((t-120)/30)))
    				Q32 = L32*sin(12*pi*((t-10)/30)) #pi*((t-120)/30))
    				Q33 = L33*sin(12*pi*((t-10)/30)) #pi*((t-120)/30))
    				Q21,Q22,Q23,Q11,Q12,Q13,Q41,Q42,Q43 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    				...
    				Q11 = L11*0.5*(1-cos(12*pi*((t-15)/30))) #pi*((t-180)/30)))
    				Q12 = L12*sin(12*pi*((t-15)/30)) #pi*((t-180)/30))
    				Q13 = L13*sin(12*pi*((t-15)/30)) #pi*((t-180)/30))
    				Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    			...
    			if t <= 5:
    				Q31 = L31*0.5*(1-cos(12*pi*(t/30))) #add'*12'
    				Q32 = L32*sin(12*pi*((t)/30))
    				Q33 = L33*sin(12*pi*((t)/30))
    				Q21,Q22,Q23,Q11,Q12,Q13,Q41,Q42,Q43 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    				...
    				Q11 = L11*0.5*(1-cos(12*pi*((t-5)/30))) #pi*((t-60)/30)))
    				Q12 = L12*sin(12*pi*((t-5)/30)) #pi*((t-60)/30))
    				Q13 = L13*sin(12*pi*((t-5)/30)) #pi*((t-60)/30))
    				Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    				...
    				Q41 = L41*0.5*(1-cos(12*pi*((t-10)/30))) #pi*((t-120)/30)))
    				Q42 = L42*sin(12*pi*((t-10)/30)) #pi*((t-120)/30))
    				Q43 = L43*sin(12*pi*((t-10)/30)) #pi*((t-120)/30))
    				Q21,Q22,Q23,Q11,Q12,Q13,Q31,Q32,Q33 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    				...
    				Q21 = L21*0.5*(1-cos(12*pi*((t-15)/30))) #pi*((t-180)/30)))
    				Q22 = L22*sin(12*pi*((t-15)/30)) #pi*((t-180)/30))
    				Q23 = L23*sin(12*pi*((t-15)/30)) #pi*((t-180)/30))
    				Q31,Q32,Q33,Q11,Q12,Q13,Q41,Q42,Q43 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    			...
    			if t <= 5:
    				Q41 = L41*0.5*(1-cos(12*pi*(t/30))) #add'*12'
    				Q42 = L42*sin(12*pi*((t)/30))
    				Q43 = L43*sin(12*pi*((t)/30))
    				Q21,Q22,Q23,Q11,Q12,Q13,Q31,Q32,Q33 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    				...
    				Q21 = L21*0.5*(1-cos(12*pi*((t-5)/30))) #pi*((t-60)/30)))
    				Q22 = L22*sin(12*pi*((t-5)/30)) #pi*((t-60)/30))
    				Q23 = L23*sin(12*pi*((t-5)/30)) #pi*((t-60)/30))
    				Q31,Q32,Q33,Q11,Q12,Q13,Q41,Q42,Q43 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    				...
    				Q11 = L11*0.5*(1-cos(12*pi*((t-10)/30))) #pi*((t-120)/30)))
    				Q12 = L12*sin(12*pi*((t-10)/30)) #pi*((t-120)/30))
    				Q13 = L13*sin(12*pi*((t-10)/30)) #pi*((t-120)/30))
    				Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    				...
    				Q31 = L31*0.5*(1-cos(12*pi*((t-15)/30))) #pi*((t-180)/30)))
    				Q32 = L32*sin(12*pi*((t-15)/30)) #pi*((t-180)/30))
    				Q33 = L33*sin(12*pi*((t-15)/30)) #pi*((t-180)/30))
    				Q21,Q22,Q23,Q11,Q12,Q13,Q41,Q42,Q43 = self.stance_joint
    				self.joint_action_pub = [Q11,Q12,Q13,Q21,Q22,Q23,Q31,Q32,Q33,Q41,Q42,Q43]
    				self.leg_joints.move_jtp(self.joint_action_pub)
    				self.save_action_record(self.joint_action_pub)
    	...
    	pose_file = 'ddpg_pinn_b_pose_for_dir_'+ str(self.dir_action) +'.csv'
    	np.savetxt(pose_file, pose_, delimiter=",") # pose for directional ,2(backward),4(left),6(right),8(forward)
    	joint_pose_ = 'ddpg_pinn_b_joint_pose_for_dir_'+ str(self.dir_action) +'.csv'
    ...
    def reset(self, goal):
    	...
    	dy = uniform(-0.5,0.5)
    	goal_pose = Pose()
    	goal_pose.position.x = float(self.pose.x) + float(dx)
    	goal_pose.position.y = float(self.pose.y) + float(dy)
    	goal_pose.position.z = float(self.pose.z)
